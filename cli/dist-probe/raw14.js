...
var usePurge = process.argv[3] === "purge";
...
if (usePurge) await new Promise((res) => port.flush(() => res()));
await new Promise((res, rej) => port.write(Buffer.from([184, 18, 241, 2, 26, 128, 195]), (e) => e ? rej(e) : res()));
await new Promise((r) => setTimeout(r, 900));
console.log(`${usePurge ? "WITH flush" : "no flush "}: first exchange got ${bytes} bytes`);
