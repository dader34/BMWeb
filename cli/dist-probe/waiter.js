...
setTimeout(() => fire(new Uint8Array([1, 2, 3])), 20);
var r = await Promise.race([pending, new Promise((res) => setTimeout(() => res("TIMEOUT"), 400))]);
console.log("armed-first read ->", r === "TIMEOUT" ? "TIMEOUT" : [...r.value].join(" "));
process.exit(0);
