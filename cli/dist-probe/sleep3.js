...
var { runInContext: runInContext2, createContext: createContext2 } = await import("node:vm");
var bus = g.webBus ?? g.window?.webBus;
console.log("bus found:", !!bus);
var src = bus && bus.constructor ? bus.constructor.toString() : "";
console.log("bus code references bmwSleep:", /bmwSleep/.test(src));
