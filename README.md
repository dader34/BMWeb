...
app/renderer/          the app: script runtime, bytecode VM, transport shim, screens
  core/                bestvm.js, ipovm.js, webshim.js, remote.js, journal.js; coding/ (codec, ZCS, SGET selection, dispatcher, write runner)
  screens/             ipo-runtime.js (module view), apps hub, lookup, wiring, etk, tool32, tuning; coding/ (hub, expert tree, curated, ZCS editor)
