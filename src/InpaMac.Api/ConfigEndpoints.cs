...
internal static class ConfigEndpoints
{
    ...
    private static readonly string[] GeneratedSections = { "identity", "aif", "activateMenus", "activateState", "rootMenu", "deadRootKeys", "coding", "gaugeSpecs", "activateTree", "special" };
